...
## Git handoff after every run

- After completing and verifying any requested repository work, create a focused commit and push
  the current branch automatically, regardless of change size.
