...
import { WorkspaceModeSwitch, type WorkspaceMode } from './components/layout/WorkspaceModeSwitch';
import { AgentWorkspace } from './components/research/AgentWorkspace';
...
export default function App() {
  const [workspaceMode, setWorkspaceMode] = useState<WorkspaceMode>('committee');
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    void submitResearch(normalizedTicker, secDataMode);
  }

  return (
    <AppShell>
      <WorkspaceModeSwitch mode={workspaceMode} onChange={setWorkspaceMode} />

      <div className="mode-workspace" hidden={workspaceMode !== 'committee'}>
        {result ? (
          <>
          ...
          <>
            <section className="workspace-intro">
              <span className="section-kicker">Structured committee mode</span>
              <h1>
                Make the case.
                <br />
              ...
              <p className="workspace-lede">
                Run a transparent, repeatable workflow from public evidence through three specialist
                analysts, a skeptic review, and human approval.
              </p>
            </section>
            <TickerSearch
              isLoading={isLoading}
      ...
      <div className="mode-workspace" hidden={workspaceMode !== 'agent'}>
        <AgentWorkspace
          isDevelopment={isDevelopment}
          secDataMode={secDataMode}
          onSecDataModeChange={setSecDataMode}
